...
//         &self,
//         before_block: u64,
//     ) -> Vec<(TxId, sapling_crypto::Nullifier)> {
...
//     pub fn get_unspent_s_nullifiers(&self) -> Vec<(sapling_crypto::Nullifier, u64, TxId)> {
//         self.current
//             .iter()
//             .flat_map(|(_, wtx)| {
//                 wtx.sapling_notes
...
//                 wtx.orchard_notes.iter_mut().for_each(|n| {
//                     n.is_change = true;
//                 });
//             });
//         }
...
//         if !wtx.sapling_notes.iter_mut().any(|n| n.note == note) {
